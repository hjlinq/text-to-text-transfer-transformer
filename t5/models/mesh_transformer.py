...
def mesh_inference_dataset_fn(
  ...
  This function is designed for language modeling tasks where we would like to
  prime the LM with some number of tokens from "targets" before doing inference.
